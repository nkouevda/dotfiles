...
[[ -r ~/.config/bash/completion.sh ]] && source ~/.config/bash/completion.sh
[[ -r ~/.config/bash/functions.sh ]] && source ~/.config/bash/functions.sh
